            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Guru</h1> <br>
                    </div>
                    <?php if (isset($_GET['status']) && $_GET['status'] == 'success'): ?>
                    <div class="alert alert-success">
                        Data Guru berhasil dikirim.
                    </div>
                    <?php endif; ?>
    ...
    <div class="modal fade" id="modalIzin" tabindex="-1" role="dialog" aria-labelledby="modalIzinLabel"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalIzinLabel">Tambah Guru</h5>
                ...
                <form action="proses.php" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_guru" class="form-control" rows="4" required></input>
                        </div>
