...
$query = mysqli_query($conn, "
    SELECT 
        jadwal_piket.id,
        jadwal_piket.tanggal_piket,
        jadwal_piket.keterangan,
        users.username
    FROM jadwal_piket
    JOIN users ON jadwal_piket.user_id = users.id
    ORDER BY jadwal_piket.tanggal_piket DESC
");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Jadwal Piket</h1> <br>
                    </div>
                                                            ...
                                                            <form action="proses_edit_jadwal.php" method="post">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="date" name="tanggal_piket"
                                                                            class="form-control"
                                                                            value="<?= $row['tanggal_piket'] ?>"
                                                                            required>
                                                                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="user_id" class="form-control" required>
                                ...
                                <?php while ($row = mysqli_fetch_assoc($queryPiket)): ?>
                                <option value="<?= $row['id'] ?>">
