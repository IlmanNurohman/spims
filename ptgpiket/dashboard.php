...
$query_total = mysqli_query($conn, "SELECT COUNT(*) as total FROM izin");
$total_izin = mysqli_fetch_assoc($query_total)['total'];

// 2. Hitung jumlah guru (role: wali)
$query_guru = mysqli_query($conn, "SELECT COUNT(*) as total FROM izin WHERE status = 'disetujui'");
$total_guru = mysqli_fetch_assoc($query_guru)['total'];

// 3. Hitung jumlah petugas (role: piket)
$query_piket = mysqli_query($conn, "SELECT COUNT(*) as total FROM izin WHERE status = 'menunggu'");
$total_piket = mysqli_fetch_assoc($query_piket)['total'];

// 4. Hitung jumlah siswa (role: siswa)
$query_siswa = mysqli_query($conn, "SELECT COUNT(*) as total FROM izin WHERE status = 'ditolak'");
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Jumlah Izin</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_izin; ?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-info" role="alert">
                                        <strong>Jadwal Piket Anda Hari Ini</strong><br>
                                        Tanggal: <?= date('d-m-Y', strtotime($jadwalHariIni['tanggal_piket'])) ?><br>
                                        Keterangan: <?= htmlspecialchars($jadwalHariIni['keterangan'] ?: '-') ?>
                                    </div>
                                    <?php else: ?>
